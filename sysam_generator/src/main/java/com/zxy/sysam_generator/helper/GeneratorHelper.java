package com.zxy.sysam_generator.helper;

import com.google.common.io.Files;
import com.zxy.sysam_generator.annotation.Helper;
import com.zxy.sysam_generator.entity.Column;
import com.zxy.sysam_generator.entity.FieldType;
import com.zxy.sysam_generator.entity.GeneratorConfig;
import com.zxy.sysam_generator.entity.GeneratorConstant;
import com.zxy.sysam_generator.utils.AddressUtil;
import com.zxy.sysam_generator.utils.ComUtils;
...
public class GeneratorHelper {
    ...
    public void generateEntityFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        columns.forEach(c -> {
            c.setField(ComUtils.underscoreToCamel(StringUtils.lowerCase(c.getName())));
    ...
    public void generateMapperXmlFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        columns.forEach(c -> c.setField(ComUtils.underscoreToCamel(StringUtils.lowerCase(c.getName()))));
        configure.setColumns(columns);
