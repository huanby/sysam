...
CREATE TABLE `sys_job`  (
  ...
  `GROUP` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '任务组名称',
  ...
  `STATUS` int(2) NOT NULL COMMENT '任务状态  0：正常  1：暂停',
